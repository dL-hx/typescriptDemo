...
var num2; //num2 即是number类型  又是 undefined类型
num2 = 123;
console.log(num2);
//定义没有赋值 默认是undefined  不会出错
var num3; //num2 即是number类型  又是 undefined类型
console.log(num3);
//null 空类型
var num4;
// num4 = 123;//空类型不能赋值
